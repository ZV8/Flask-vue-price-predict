...
5. Разработать клиентскую часть (Vue.js) для возможности обращения к серверу и получения в ответ предсказания модели для обекта недвижимости.

6. Упаковать все в докер.
   
   Использовал docker-compose для объединения контейнеров: 
      - для разработки "flask" + "vue";
      - для прода "flask и nginx" + "vue".
...
## Общие выводы и возможные улучшения.
   ...
   Главной целью проекта было показать пример доведения применения модели до прода с упаковкой кода в докер-контейнеры и максимально простого развертывания на сервере.
